...
class FileListener
{
    public function __construct(
        ...
        private readonly CacheInterface $domainCache,
...
> 実際には `postLoad()` ではS3から取得した署名付き一時URLを [symfony/cache](https://symfony.com/doc/current/components/cache.html) 経由でRedisにキャッシュしているのですが、ここでは省略してご紹介しています。
